<template>
  <div class="min-h-full w-full flex flex-col sm:flex-row">
    <div
      class="min-w-64 sticky top-0 sm:border-r border-gray-400 bg-gray-200 shadow sm:shadow-none z-50"
    >
    ...
    <div class="h-full flex flex-wrap py-8 px-2 sm:px-6 overflow-y-auto">
      <slot name="main"></slot>
    </div>
  </div>
</template>
